...
function calcular() {
  ...
  mostrarTIR("tirB", calcularTIR(b3, precioActual, 3));
  mostrarTIR("tirH", calcularTIR(h3, precioActual, 3));
  mostrarTIR("tirE", calcularTIR(e3, precioActual, 3));
  ...
  // Señal de Inversión
  let signalText="", signalIcon="", comentario="**Calculado en base a superar 15% de margen.";
  if (margin >= 0.15) { signalText="Comprar"; signalIcon="🟢⬆️"; }
  else { signalText="Mantener"; signalIcon="🟡➖"; }
